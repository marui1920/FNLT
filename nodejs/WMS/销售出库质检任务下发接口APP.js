class App {
    onCreate(appGuid) {
        ...
        app.post("/getWMS_CKSJ", function (req, res) {
            TraceInfo("getWMS_CKSJ","");
            const date = new Date();
                ...
                if ( !res1.ret ) {
                    ...
                    RealtimeAddThingRecord(objectID1,recordValues1,function (res2) {
                        if ( !res2.ret ) {
                            ...
                            //业务处理
                            TraceInfo("添加销售出库质检任务下发及质检下发数据失败");
                            obj = {
                                "Response": {
                                    "return": {
                                        "returnCode": "0001",
        ...
        //绑定和侦听指定主机和端口上的连接
        var server = app.listen(30012, "172.16.24.205", function () {
